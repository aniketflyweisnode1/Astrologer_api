...
// Import controllers
const { createStatus, getAllStatuses, getStatusById, updateStatus, updateAllStatuses, deleteStatus } = require('../../controllers/status.controller');  
// Import middleware
const { auth } = require('../../../middleware/auth');
const { validateBody, validateQuery, validateParams } = require('../../../middleware/validation');
// Import validators
const { createStatusSchema, updateStatusSchema, updateAllStatusesSchema, getStatusByIdSchema, getAllStatusesSchema } = require('../../../validators/status.validator'); 
